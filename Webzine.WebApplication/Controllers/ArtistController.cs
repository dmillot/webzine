...
namespace Webzine.WebApplication.Controllers
{
    public class ArtistController : Controller
    {
        ...
        public IActionResult Index(string artistName)
        {
            ...
            {
                NomArtiste = artistName,
                BiographieArtiste = @"Vangelis (Βαγγέλης, diminutif d’Evángelos, à prononcer Vanguélis), Evángelos Odysséas Papathanassíou (en grec : Ευάγγελος Οδυσσέας Παπαθανασίου), né le 29 mars 1943 à Vólos en Grèce1, est un musicien et compositeur, connu dans les domaines de la musique new age et électronique, et auteur de musiques de films.
                ...
                Tracks = new List<Titre>()
                {
                    new Titre()
                    {
                        TrackTitle = "blade runner - end titles",
                        Duree = "4:39",
